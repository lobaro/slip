...
const FCS_INITIAL = 0xffff
const FCS_GOOD = 0xf0b8

var fcstab [256]uint16 = [256]uint16{
...
func CalcFcs16(data []byte) uint16 {
	return CalcFcs16WithInit(FCS_INITIAL, data)
}
...
func RemoveFcs16(dataWithCrc []byte) []byte {
	return dataWithCrc[:len(dataWithCrc)-2]
}

func CheckFsc16(dataWithCrc []byte) bool {
	fcs := CalcFcs16(dataWithCrc)
	return fcs == FCS_GOOD
}
